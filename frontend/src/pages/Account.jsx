...
export default function Account() {
  ...
  const fetchAllStudents = useCallback(async () => {
    try {
      const response = await studentService.reqFetchAllStudents(
        currentPage,
        recordsPerPage
      );
        ...
        <div>
          <div className="flex flex-col">
            <div className="flex justify-end p-10">
              <Link
                className="rounded-lg bg-primary text-white p-2 px-5 border border-black hover:bg-white hover:border-black hover:text-black"
                to={"/addStudent"}
              >
                + New
              </Link>
            ...
            <div className="drop-shadow rounded-lg border border-black min-h-screen p-5 m-5">
              <div className="flex justify-between p-5">
                ...
                <div className="flex space-x-4 m-2">
                  <div className="relative">
                    ...
                    {searchQuery && (
                      <button
                        onClick={() => setSearchQuery("") || fetchAllStudents()}
                  ...
                  <button
                    className="bg-primary text-white p-2 px-5 border border-black rounded-lg"
              ...
              <div>
                        ...
                        <tr key={student._id}>
                          ...
                          <td className="border border-black p-2 text-center">
                            ...
                            <button
                              ...
                              onClick={() =>
                                handleDelete(student._id, student.student_id)
                              }
                            >
                              Delete
                            </button>
                ...
                <div className="flex justify-center py-5">
                  {!(
                    fetchedStudents.length < 10 && fetchedStudents.total < 10
                  ) ? (
