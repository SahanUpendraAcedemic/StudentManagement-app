...
export default function () {
  ...
  const validateFrom = (e) => {
    if (
      ...
      e.target.sln.value === "" ||
      e.target.scn.value === "" ||
      e.target.saddress.value === "" ||
      e.target.sgender.value === "" ||
      e.target.sdob.value === "" ||
      e.target.endate.value === "" ||
      e.target.fedu.value === "" ||
      e.target.egrade.value === ""
    ) {
  ...
  const handelSubmit = (e) => {
    ...
    if (validateFrom(e)) {
      setStudentDetails({
        ...
        schol_eligibility:
          e.target.scholarship.value === "on" ? "Eligible" : "Not Eligible",
  ...
  return (
    <div>
      <div className="m-5">
        ...
        >
          ...
          <div className="w-full">
            <h4 className="text-sm">General</h4>
          ...
          <CollapsibleDiv
            content={
              <>
                <div className="w-full">
                  <label className="text-semibold">
                    ...
                    <input
                      ...
                      id="sid"
                      name="sid"
                      placeholder='Student Id:"S01"'
                      className="rounded-lg border border-black p-2 focus:drop-shadow focus:scale-105 w-full"
                      autoFocus
                    />
                  </label>
                </div>
                ...
                <div className="w-full">
                  <label className="text-semibold m-2">
                ...
                <div className="w-full">
                  ...
                  <select
                    id="sgender"
                    placeholder="Gender"
                    className="rounded-lg border border-black p-2 focus:drop-shadow w-full"
                  >
            ...
            content={
              <>
                ...
                <div className="w-full flex flex-row justify-between">
                  <lable className="text-semibold">
                    Applicable for Scholarships
                  </lable>
                  <input
                    type="checkbox"
                    id="scholarship"
                    name="scholarship"
                    className="rounded-lg border border-black p-2 focus:drop-shadow"
                  />
                </div>
              </>
            }
          ...
          <div className="w-full flex flex-row justify-between">
            <button
              className="rounded-lg bg-primary text-white p-2 px-5 border border-black hover:bg-white hover:border hover:border-black hover:text-black"
              type="submit"
            >
              Add Student
            </button>
            <button
              className="rounded-lg hover:bg-primary hover:text-white p-2 px-5 border border-black bg-white text-black"
              type="reset"
            >
              Reset
            </button>
      ...
      <PopupWindow
        ...
        onConfirm={setStudent}
        title="Confirm Adding Record?"
        message="Are you sure you want Commit?"
        confirmText="Confirm"
        cancelText="Cancel"
