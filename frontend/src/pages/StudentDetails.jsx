                ...
                {studentDetails ? (
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input className="w-full p-2" type="text" value={studentDetails.student_id} readOnly />
                                </td>
                        </tr>
                        <tr>
                            <td className="font-semibold">First Name</td>
                            <td>
                                <input className="w-full p-2" type="text" name='student_firstName' defaultValue={studentDetails.student_firstName} onChange={handleInputChange} />
                            </td>
                        </tr>
                        <tr>
                            <td className="font-semibold">Last Name</td>
                                <td>
                                <input className="w-full p-2" type="text" name='student_lastName' defaultValue={studentDetails.student_lastName} onChange={(e) => {
                            ...
                            <td>
                                <input className="w-full p-2" type="text" name='student_credetialName' defaultValue={studentDetails.student_credetialName} onChange={(e) => {
                            ...
                            <td className="font-semibold">Address</td>
                                <td>
                                    <input className="w-full p-2" type="text" name='student_address' defaultValue={studentDetails.student_address} onChange={(e) => {
                            ...
                            <tr>
                                ...
                                <td>
                                    <select className="w-full p-2" name='student_gender' defaultValue={studentDetails.student_gender} onChange={(e) => {
                            ...
                            <tr>
                                ...
                                <td>
                                    <input className="w-full p-2" type="date" name='student_dob' defaultValue={studentDetails.student_dob ? new Date(updateStudentDetails.student_dob).toISOString().split('T')[0] : ''} onChange={(e) => {
                            ...
                            <td className="font-semibold">Date Of Enrollment</td>
                                <td>
                                    <input className="w-full p-2" type="date" name='enrolldate' defaultValue={studentDetails.enrolldate ? new Date(updateStudentDetails.enrolldate).toISOString().split('T')[0] : ''} onChange={(e) => {
                                        setUpdateStudentDetails(prev => ({ ...prev, enrolldate: e.target.value }));
                                        setIsUpdated(true);
                                    }} />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select className="w-full p-2" name='formerEducation' defaultValue={studentDetails.formerEducation} onChange={(e) => {
                            ...
                            <tr>
                                ...
                                <td>
                                    <input className="w-full p-2" type="text" name='schol_eligibility' defaultValue={studentDetails.schol_eligibility} onChange={(e) => {
                            ...
                            <tr>
                                <td colSpan="2" className="text-sm italic">
                                    {"Created at " + new Date(studentDetails.created_at).toLocaleDateString()}
                                ...
                                <tr>
                                    <td colSpan="2" className="text-center">
                                        <button className={`rounded-lg p-2 mt-2 px-5 border border-black ${isUpdated ? 'bg-primary text-white' : 'bg-gray-300 text-gray-500 cursor-not-allowed'}`} 
                                            onClick={handleUpdate} disabled={!isUpdated}>
                                            Update
                                        </button>
                                    </td>
                                </tr>
                        </tbody>
                    </table>) : loading ? 'Loading...' : 'No student details found!'
                }
            </div>
        </div>
    );
